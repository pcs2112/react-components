...
export const withPagination = (WrappedComponent) => {
  class WithPagination extends Component {
    static propTypes = {
      ...
      prevPageLabel: PropTypes.oneOfType([PropTypes.string, PropTypes.bool]),
      nextPageLabel: PropTypes.oneOfType([PropTypes.string, PropTypes.bool]),
    ...
    getPageRange() {
      ...
      let beginPage = Math.max(0, currentPage - parseInt(maxButtonCount / 2, 10));
