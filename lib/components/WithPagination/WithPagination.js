...
var withPagination = exports.withPagination = function withPagination(WrappedComponent) {
  ...
  WithPagination.propTypes = {
    ...
    prevPageLabel: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.bool]),
    nextPageLabel: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.bool]),
