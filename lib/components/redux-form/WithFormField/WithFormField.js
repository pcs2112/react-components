...
var withFormField = function withFormField(WrappedComponent, WrappedInputComponent) {
  var WithFormField = function WithFormField(_ref) {
    ...
    return _react.default.createElement(WrappedComponent, _extends({}, fieldProps, {
      error: hasError
    }), label && _react.default.createElement("label", null, label) // eslint-disable-line
    , _react.default.createElement(WrappedInputComponent, _extends({}, props, {
