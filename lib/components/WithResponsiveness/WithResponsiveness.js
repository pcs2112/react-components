...
exports.withReponsiveness = undefined;
 ...
 */
var withReponsiveness = exports.withReponsiveness = function withReponsiveness(WrappedComponent) {
  ...
  var WithReponsiveness = function (_Component) {
    _inherits(WithReponsiveness, _Component);

    function WithReponsiveness(props) {
      _classCallCheck(this, WithReponsiveness);

      var _this = _possibleConstructorReturn(this, (WithReponsiveness.__proto__ || Object.getPrototypeOf(WithReponsiveness)).call(this, props));
    ...
    _createClass(WithReponsiveness, [{
  ...
  WithReponsiveness.displayName = 'WithReponsiveness(' + (0, _utils.getDisplayName)(WrappedComponent) + ')';
